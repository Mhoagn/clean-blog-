      ...
      <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto py-4 py-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/clean-blog/posts/create.php"
                >Create</a
              >
            </li>
            ...
            <?php else : ?>
            <li class="nav-item">
              <a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/clean-blog/auth/login.php"
                >login</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link px-lg-3 py-3 py-lg-4" href="http://localhost/clean-blog/auth/register.php"
                >register</a
              >
            </li>
            <?php endif; ?>  
