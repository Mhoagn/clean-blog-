...
<?php
  ...
  $select = $con->prepare("SELECT p.id AS post_id,p.title, c.name AS category_name,u.username FROM posts p
                          JOIN categories c
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $da->username; ?></td>
                     <td><a href="http://localhost/clean-blog/admin-panel/posts-admins/delete-post.php?del_post_id=<?php echo $da->post_id; ?>" class="btn btn-danger  text-center ">delete</a></td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
              </table> 
